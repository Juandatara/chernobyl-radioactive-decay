...
\begin{itemize}
    ...
    \item \textbf{Radiación Alfa ($\alpha$):} Consiste en la emisión de un núcleo de helio ($^4_2He$), formado por dos protones y dos neutrones. Posee una gran masa (más de 7000 veces la de una partícula beta) y carga eléctrica, lo que le da un alto poder de ionización pero un alcance muy corto en la materia, siendo incapaz de atravesar incluso la piel humana.
