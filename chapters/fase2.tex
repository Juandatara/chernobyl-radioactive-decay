...
& Documento de normas de seguridad del OIEA orientado a la gestión, monitoreo y rehabilitación de emplazamientos afectados por contaminación radiactiva.
& Promueve la adopción internacional de estándares de seguridad y su incorporación en las regulaciones nacionales relacionadas con la remediación y gestión postaccidente.
& Evidencia la importancia de implementar protocolos de rehabilitación y monitoreo ambiental para reducir el riesgo radiológico en zonas contaminadas.
& La aplicación de las recomendaciones puede verse limitada por deficiencias institucionales, falta de recursos o dificultades en la implementación adecuada de los reglamentos establecidos por el OIEA. \\
\hline
