...
& 2023
& Long-term study on the distribution of \ce{^{137}Cs} in soil following the Chernobyl nuclear accident: a comparison of temporal migration measurements and compartment model predictions
& El estudio analiza el comportamiento del \ce{^{137}Cs} en el suelo desde el accidente de Chernóbil, evaluando su migración a lo largo de más de 30 años. Asimismo, busca determinar si este comportamiento puede describirse mediante un modelo matemático simplificado y evaluar si la difusión es el mecanismo dominante.
& Se realizaron mediciones durante más de 30 años en un mismo sitio, tomando muestras de suelo segmentadas en capas de 5 cm hasta una profundidad de 30 cm. Se cuantificó la actividad del \ce{^{137}Cs} en cada capa y se analizó su distribución temporal. Posteriormente, los resultados se compararon con un modelo de compartimentos que describe la transferencia del radionúclido entre capas con el tiempo.
& Los resultados muestran que el \ce{^{137}Cs} presenta una migración lenta en el suelo, desplazándose gradualmente hacia capas más profundas. El modelo de compartimentos con tasa de transferencia constante describe adecuadamente la tendencia general observada en los datos.
& Se observa una alta dispersión en los datos, especialmente en capas profundas, lo que introduce incertidumbre en las conclusiones. El modelo utilizado es simplificado y no incorpora todos los procesos físicos y químicos del suelo. Además, el estudio se limita a un único sitio, lo que restringe su generalización. Por otra parte, el modelo basado únicamente en difusión no concuerda con los resultados experimentales, lo que sugiere que otros procesos, como el transporte asociado al movimiento del agua, desempeñan un papel relevante. \\
\hline
