...
& nuclear-power.com (sitio educativo, no revista científica) 
& Explica el decaimiento radiactivo como un proceso espontáneo y probabilístico en el cual núcleos inestables emiten radiación (α, β, γ) para alcanzar mayor estabilidad; introduce conceptos clave como vida media y leyes de conservación, con aplicaciones en física nuclear y reactores. \\
\hline

Radioactive Decay 
& Paola Cappellaro 
& Physics LibreTexts (MIT OpenCourseWare, recurso educativo) 
& Describe el decaimiento radiactivo como el proceso mediante el cual un núcleo inestable pierde energía espontáneamente emitiendo partículas y radiación ionizante; introduce el concepto de inestabilidad nuclear y su carácter espontáneo dentro del marco de la física nuclear básica. \\
\hline
